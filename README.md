...
- [Baixar para Windows (`yt-dlp-deck.exe`)](https://github.com/LucasPreto0000/yt-dlp-deck/releases/download/v1.1.7/yt-dlp-deck.exe)
- [Baixar para Android ARM64 (`.apk`)](https://github.com/LucasPreto0000/yt-dlp-deck/releases/download/v1.1.7/YT-DLP-Deck-Android-v1.1.7-arm64.apk)
- [Ver a release completa e as notas da versão](https://github.com/LucasPreto0000/yt-dlp-deck/releases/tag/v1.1.7)
...
`src-tauri\target\android\YT-DLP-Deck-Android-v1.1.7-arm64.apk`
...
`src-tauri\target\android\YT-DLP-Deck-Android-v1.1.7-arm64.aab`
