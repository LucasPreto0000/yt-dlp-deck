...
- [Baixar para Windows (`yt-dlp-deck.exe`)](https://github.com/LucasPreto0000/yt-dlp-deck/releases/download/v1.1.2/yt-dlp-deck.exe)
- [Baixar para Android ARM64 (`.apk`)](https://github.com/LucasPreto0000/yt-dlp-deck/releases/download/v1.1.2/YT-DLP-Deck-Android-v1.1.2-arm64.apk)
- [Ver a release completa e as notas da versão](https://github.com/LucasPreto0000/yt-dlp-deck/releases/tag/v1.1.2)
...
`src-tauri\target\android\YT-DLP-Deck-Android-v1.1.2-arm64.apk`
...
`src-tauri\target\android\YT-DLP-Deck-Android-v1.1.2-arm64.aab`
